        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-12 xl:col-span-4 space-y-6 sticky top-28">
            ...
            <Card className="rounded-[2rem] border-0 shadow-sm p-8 space-y-6">
               ...
               <div className="space-y-4">
                  <a href={`tel:${business.phone_number}`} className="flex items-center gap-4 p-4 rounded-2xl hover:bg-slate-50 transition-all group border border-transparent hover:border-slate-100">
                     ...
                     <div>
                       ...
                       <p className="text-slate-800 font-black">{business.phone_number || '4444-5555'}</p>
                     </div>
                  </a>
